      ...
      <div className="p-3 space-y-4">
        ...
        <div className="space-y-3">
          ...
          <p className="text-xs text-zinc-500">
            {controller}: {maxPorts} ports | Click "Route" then click cabinets in order
          </p>
            ...
            <div className="space-y-2">
              {dataRoutes.map((route) => {
                ...
                return (
                  <div
                    key={route.id}
                    className={`rounded-lg p-2 space-y-2 ${isActiveRoute ? "bg-orange-500/20 border border-orange-500/50" : "bg-zinc-800/50"}`}
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm font-medium text-zinc-200">Port {route.port}</span>
                    ...
                    <div className="text-xs text-zinc-400">
                      {route.cabinetIds.length > 0 ? (
                        <span className="font-mono text-zinc-300">{route.cabinetIds.join(" → ")}</span>
                      ) : (
            ...
            <div className="space-y-3">
              {powerFeeds.map((feed, index) => {
                ...
                return (
                  <div
                    key={feed.id}
                    className={`rounded-lg p-2 space-y-2 ${isActiveFeed ? "bg-blue-500/20 border border-blue-500/50" : "bg-zinc-800/50"}`}
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <span className="w-6 h-6 rounded bg-blue-500 text-white text-xs font-bold flex items-center justify-center">
                          {index + 1}
                        </span>
                        <span className="text-sm font-medium text-zinc-200">Feed {index + 1}</span>
                        <Badge variant="secondary" className="text-xs">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div className="space-y-1">
                        ...
                        <Input
                          ...
                          className="h-7 text-xs bg-zinc-900 border-zinc-700 text-zinc-200"
                    ...
                    <div className="space-y-1">
                      ...
                      <Input
                        ...
                        onBlur={() => dispatch({ type: "PUSH_HISTORY" })}
                        className="h-7 text-xs bg-zinc-900 border-zinc-700 text-zinc-200 font-mono"
                        placeholder="0"
                      />
                    </div>
                  </div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-2">
                <div className="flex items-center justify-between text-sm">
                  <span className="text-blue-400 font-medium">Total Consumption:</span>
